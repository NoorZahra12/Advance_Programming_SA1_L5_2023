...
# Now create subclasses for a circle, rectangle, and triangle. These should include an appropriate  
# area() method that will use the side values from the shape class.    