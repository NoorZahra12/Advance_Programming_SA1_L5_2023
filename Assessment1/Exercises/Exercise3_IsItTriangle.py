...
# Use the triangle inequality to determine if we have a triangle: In mathematics, the triangle 
#inequality states that for any triangle, the sum of the lengths of any two sides must be greater 
#than or equal to the length of the remaining side 
#([see here](https://en.wikipedia.org/wiki/Triangle_inequality))
# Extension Problem (Optional):
# If valid, as the user for the length of the sides and have the program correctly 
